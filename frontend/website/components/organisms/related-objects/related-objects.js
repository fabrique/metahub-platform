...
export default class RelatedObjects extends Component {
  init () {
    this.observer = null
...
window.addEventListener('init-load', () => document.querySelectorAll('.related-objects').forEach(element => {
  element.instance = element.instance || new RelatedObjects(element)
}))
