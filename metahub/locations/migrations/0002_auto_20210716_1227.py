# Generated by Django 3.1.12 on 2021-07-16 12:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='authors',
            field=wagtail.core.fields.StreamField([('author', wagtailmodelchooser.blocks.ModelChooserBlock(icon='user', target_model='authors.author'))], blank=True),
        ),
        migrations.AlterField(
            model_name='metahublocationpage',
            name='content',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_object', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='tagged_objects', to='locations.metahublocationpage')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='locations_locationtag_items', to='taggit.tag')),
            ],
            options={
                'abstract': False,
            },
